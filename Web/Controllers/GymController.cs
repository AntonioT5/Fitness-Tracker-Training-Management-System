...
{
    private readonly GymMapper _mapper;
    
    public GymController(GymMapper mapper)
    {
        _mapper = mapper;
    }
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] GymRequest request)
    {
