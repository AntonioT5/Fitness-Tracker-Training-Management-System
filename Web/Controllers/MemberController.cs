...
public class MemberController : ControllerBase
{
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] MemberRequest request)
    {
        try
        {
        ...
        catch (InvalidOperationException e) when (e.Message.Contains("Member"))
        {
